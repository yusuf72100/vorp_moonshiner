    ...
    while placing do
        ...
        if PromptHasHoldModeCompleted(BuildPrompt) then
            ...
            if propName == Config.brewProp then
                ...
                TriggerEvent("vorp:TipBottom", "You placed the distillery", 4000)
                inplacing = false
            else
                ...
                TriggerEvent("vorp:TipBottom", "You placed the barrel", 4000)
                inplacing = false
            end
...
AddEventHandler('moonshiner:deleteprop', function(id, object, xpos, ypos, zpos)
    ...
    if object == Config.brewProp then
        ...
        TriggerEvent("vorp:TipBottom", "You took back the barrel", 4000)
    end
	destroying = false
end)
